...
<body class="antialiased">
  <div>
    <a href="{{url('registros/crear')}}" class="btn btn-warning">Registrar ingreso</a>
  </div>
  <br>
      <div class="col-xl-12">
    ...
    <form action="{{route('buscarrut')}}" method="get">
      <div class="form-row">
          <div class="cl-sm-7 my-1">
            ...
            <div class="col-auto my-1">
            <input type="submit" class="btn btn-primary" value="Buscar Rut">
          </div>
      </div>
  </div>
<br>
                          ...
                          <table class="table">
                                  ...
                                  <tbody>
                                    ...
                                    <tr>
                                      ...
                                      <td>
                                            <a href="{{route('editarSalida',$registro['id'])}}" class="btn btn-warning">Registrar salida</a>
