...
<head>
    ...
    <title>TPS PARKING - Inicio</title>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                ...
                                <i class="fas fa-user fa-2x fa-fw mr-2 text-gray-40"></i>
                            </a>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <a href="lista_SVaras.html" class="btn btn-primary btn-icon-split btn-primary">
                                                <span class="icon text-white-60">
                                                   <i class="fas fa-car"></i> 
                                                </span><span class="text">SECTOR A. VARAS</span>
                                            </a>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-s font-weight-bold text-secondary text-uppercase mb-1">
                                                8 DISPONIBLES</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"></div>
                                            <a href="tabla _sector_2.html" class="btn btn-primary btn-icon-split btn-primary">
                                                <span class="icon text-white-60">
                                                    <i class="fas fa-car"></i> 
                                                </span><span class="text">SECTOR 50</span>
                                            </a>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-s font-weight-bold text-secondary text-uppercase mb-1">
                                                0 DISPONIBLES</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"></div>
                                            <a href="tabla _sector_3.html" class="btn btn-primary btn-icon-split btn-primary">
                                                <span class="icon text-white-60">
                                                    <i class="fas fa-car"></i> 
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-s font-weight-bold text-secondary text-uppercase mb-1">
                                                8 DISPONIBLES</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"></div>
                                            <a href="tabla _sector_4.html" class="btn btn-primary btn-icon-split btn-primary">
                                                <span class="icon text-white-60">
                                                    <i class="fas fa-car"></i> 
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Copyright &copy; TPS Parking 2022</span>
                    </div>
                </div>
            </footer>
            <!-- End of Footer -->
